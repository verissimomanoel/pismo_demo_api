...
import br.com.pismo.demo.api.auth.*;
...
public class AuthServiceImpl implements AuthService {
    public static final String PERFIX_BEARER = "Bearer";
    ...
    public CredentialTO refresh(final RefreshTO refreshTO) {
        ...
        if (!resolve.isRefreshToken()) {
            throw new BusinessException(PismoDemoMessageCode.ERROR_TOKEN_INVALID);
        }
    ...
    private ClaimResolve getClainResolve(String token) {
        token = token.replace(PERFIX_BEARER, "").trim();
