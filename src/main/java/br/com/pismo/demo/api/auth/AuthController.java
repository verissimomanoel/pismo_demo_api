...
public class AuthController {
    ...
    public ResponseEntity<CredentialTO> login(
    ...
    public ResponseEntity<CredentialTO> refresh(@ApiParam(value = "Informações de Autenticação", required = true) @Valid @RequestBody final RefreshTO refreshTO) {
